...
function generateHexCode() {
  ...
  const hexavalues: string = "0123456789ABCDEF"; //HEXADECIMAL REPRESENTATION
  let hexColor = "#"; //hexcolor is a variable,it has # init as avalue.
  ...
  for (let i = 0; i < 6; i++) {
    ...
    const random_hexa_decimal_colorcode = Math.floor(Math.random() * 16);
